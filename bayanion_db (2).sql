...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2018 at 07:38 AM
...
(1, 'Basubas', 'Tipolo', 'Mandaue', 6014, 'Cebu'),
...
(9, 'ac', 'looc', 'mandaue', 6014, 'cebu'),
(10, 'admin', 'admin', 'admin', 1234, 'admin');
...
INSERT INTO `admin` (`admin_id`, `user_id`, `admin_firstname`, `admin_middlename`, `admin_lastname`, `admin_birthdate`, `admin_gender`) VALUES
(1, 8, 'admin', 'admin', 'admin', '2018-02-01', 'female');
...
(5, 2, 'public', 0x636c6f746865732e6a7067, 'i donate this!', '', '2018-02-07 23:13:30', 1),
(6, 2, 'public', 0x646f776e6c6f61642e6a7067, 'donation campaign!', '', '2018-01-27 14:43:03', 1),
(7, 3, 'public', 0x646f776e6c6f6164202832292e6a7067, 'donationssssss', '', '2018-02-08 20:19:26', 3),
(8, 7, 'public', 0x737175616466616d2e6a7067, 'Im so fancy;;;;;;', '', '2018-02-09 23:47:38', 1);
...
(3, 7, 0x737175616466616d2e6a7067, 'The shonga team', 'We are infinite... ', 'ian123', 'mae', '2018-02-09 23:50:32');
...
(4, 7, 'juan', 'pareja', 'montebon', '1967-03-04', 'Male');
...
INSERT INTO `markers` (`location_id`, `name`, `address`, `population`, `lat`, `lng`, `type`) VALUES
(1, 'Subangdaku Barangay Hall', 'Albaño Street, Mandaue City, 6014 Cebu', 20333, 10.320812, 123.924667, 'hall');
...
(1, 0, 7, 0, 1, 'hi chemay', '2018-02-06 01:18:10', 1),
(2, 0, 6, 0, 3, 'hi try1', '2018-02-06 01:40:25', 1),
(3, 0, 1, 0, 3, 'hi try', '2018-02-06 02:21:09', 1),
(4, 0, 4, 0, 1, '@try1', '2018-02-06 03:41:08', 1),
(5, 0, 8, 0, 7, 'omg ur so ambitious....\r\n', '2018-02-09 23:48:49', 1);
...
(1, 3, 'public', 'dsfxgcvhbnm,nbvcxz', '', '2018-02-07 14:40:43', 4),
(2, 1, 'public', 'sdcvbhesrdf', '', '2018-02-07 23:13:14', 1),
...
(7, 9, 'individual', 0x737175616466616d2e6a7067, 'ian@google.com', 9423477514, 1234567, 'ian123', 'ian123'),
(8, 10, 'admin', 0x646275672e6a7067, 'admin@gmail.com', 999999999999, 33333333, 'admin', 'admin');
...
--
ALTER TABLE `individual_user`
  MODIFY `iu_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
