<?php
  ...
  $result_campaign = mysqli_query($connect_campaign,"SELECT * FROM donation_campaign INNER JOIN users ON donation_campaign.user_id=users.user_id WHERE donation_campaign.post_status='timeline' AND users.username='". $_SESSION["username"] ."'");
...
<?php
  ...
  //code to display donation posts
  $result_testimonies = mysqli_query($connecttest,"SELECT * FROM testimonies INNER JOIN users ON testimonies.user_id=users.user_id WHERE testimonies.post_status='timeline' AND users.username='". $_SESSION["username"] ."'");
