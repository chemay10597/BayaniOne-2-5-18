<?php
  ...
  $result = mysqli_query($connect,"SELECT * FROM donation_campaign INNER JOIN users ON donation_campaign.user_id=users.user_id WHERE donation_campaign.post_status='public' AND users.username='". $_SESSION["username"] ."'");
